...
!(function (e, t) {
  ...
  return function (t, n) {
    ...
    function s(e) {
      y.action.addMessage && h.message.human({ delay: 100, content: e }),
    ...
    function l(e) {
      return (
        d(e),
        c({ type: "text", cssClass: "", autoHide: !0, addMessage: !0 }, e),
    ...
    e.Promise ||
      Promise ||
      options.promise ||
      r("https://cdn.jsdelivr.net/es6-promise/4.1.0/es6-promise.min.js");
    var w = {
      template:
      ...
      methods: {
        ...
        handle_action_text: function () {
          this.action.text.value &&
            ...
            p({ type: "text", value: this.action.text.value }),
            (this.action.text.value = ""));
        },
      },
    };
...
function bot_ui_ini() {
  var botui = new BotUI("hello-Hesperus");
  botui.message
    .add({
      delay: 800,
      content: "Hi, there👋",
  ...
  var sure = function () {
        ...
        .then(function () {
          botui.message
            .add({
              delay: 1500,
              content:
                "因初中时参加电脑兴趣班,制作过flash动画,被软件制作渲染的技术所吸引",
            })
            .then(function () {
              botui.message
                .add({
                  delay: 1200,
                  content:
                    "当时呢,参加兴趣班还有我的班长同学,他的💻技术很厉害,一起交流请教,渐渐喜欢上...",
                })
                .then(function () {
                  botui.message
                    .add({
                      delay: 1500,
                      content:
                        "大学阶段,配置了个人电脑,开始网上看视频、blog自学,熟悉HTML/CSS/JavaScript/Vue/Angular1，折腾过微信小程序",
                    })
                    .then(function () {
                      botui.message
                        .add({
                          delay: 1500,
                          content:
                            "早期开发过门户网站，b2c网站；也研发过app端，目前主要开发多数是后台管理系统",
                        })
                        .then(function () {
                          botui.message
                            .add({
                              delay: 1800,
                              content:
                                "平时吗？运动方面而言，球类运动玩的都不错，也喜欢玩电子游戏；偶尔折腾学习使用ps,fcpx...",
                            })
                            .then(function () {
                              botui.action
                                .button({
    ...
    thirdpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content: "Hesperus英译金星，也称长庚星，是金星里的晨昏星.",
        })
        .then(function () {
          botui.message
            .add({
              delay: 1800,
              content:
                "金星的另外一个是phosphorus启明星，和Hesperus共同组成了金星venus.",
            })
            .then(function () {
              botui.message
                .add({
                  delay: 1800,
                  content:
                    "金星是唯一一个没有磁场的星球,在八大行星中轨道最接近圆形,且在地球上观看金星只能是黎明或傍晚!当然还有另外一层含义，我就不多说明，好奇的话可以去查查看，给自己科普下 *^_^*",
                })
                .then(function () {
                  botui.action
                    .button({
    ...
    fourthpart = function () {
      botui.message
        .add({
          delay: 1e3,
          content:
            "因为GitHub的logo就是猫元素,个人也挺喜欢猫咪,想做一名铲屎官...",
        })
        .then(function () {
          botui.message
            .add({
              delay: 1100,
              content:
                "其次呢,博客使用的 Mashiro&Hojun 的主题,简直涨在我的审美上",
            })
            .then(function () {
              botui.action
                .button({
