...
function nextBG() {
  bgindex = bgindex + 1;
  if (bgindex > 10) bgindex = 1;
  $(".centerbg").css(
    "background-image",
    'url("' + `${bg}${formatZero(bgindex, 2)}.jpg` + '")'
  );
}

function preBG() {
  bgindex = bgindex - 1;
  if (bgindex < 1) bgindex = 10;
  $(".centerbg").css(
    "background-image",
    'url("' + `${bg}${formatZero(bgindex, 2)}.jpg` + '")'
  );
...
$(document).ready(function () {
  var bgindex = Math.floor(Math.random() * bg_num + 1);
  $(".centerbg").css(
    "background-image",
    'url("' + `${bg}${formatZero(bgindex, 2)}.jpg` + '")'
  );
...
var home = location.href,
  ...
  Siren = {
    ...
    LV: function () {
      ...
      $("#video-random").on("click", function () {
        Siren.randomsource();
      });
    },
    AH: function () {
    ...
    (function () {
      if (window.AudioContext) {
        var e = new AudioContext(),
          t =
            "880 987 1046 987 1046 1318 987 659 659 880 784 880 1046 784 659 659 698 659 698 1046 659 1046 1046 1046 987 698 698 987 987 880 987 1046 987 1046 1318 987 659 659 880 784 880 1046 784 659 698 1046 987 1046 1174 1174 1174 1046 1046 880 987 784 880 1046 1174 1318 1174 1318 1567 1046 987 1046 1318 1318 1174 784 784 880 1046 987 1174 1046 784 784 1396 1318 1174 659 1318 1046 1318 1760 1567 1567 1318 1174 1046 1046 1174 1046 1174 1567 1318 1318 1760 1567 1318 1174 1046 1046 1174 1046 1174 987 880 880 987 880".split(
              " "
            ), //天空之城
          ...
          n = !1;
        $(
          "site-title, #moblieGoTop, .site-branding, .searchbox, .changeSkin-gear, .menu-list>li#star-bg"
